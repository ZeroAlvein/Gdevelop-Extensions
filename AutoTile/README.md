...
D - finally we 1st copy/paste B onto D then C onto D and we get nice 9 tiles shape (remove parts that exceed C)  
...
And that is all you need to know to use this extension so go AutoTile yoursef.
